...
const { getAddressFromCoords, calculateETA, getIpLocation } = require('../controllers/locationController');
...
// Approximate location from the request IP (GPS fallback)
router.get('/ip', locationLimiter, getIpLocation);
